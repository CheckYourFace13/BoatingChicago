...
const partnerCategories = [
  { icon: "🚤", label: "Boat & Party Boat Rentals" },
  { icon: "🛥️", label: "Yacht Charters" },
  { icon: "🎣", label: "Fishing Charters" },
  { icon: "🧑‍✈️", label: "Captains for Hire" },
  { icon: "⚓", label: "Marinas & Harbors" },
  { icon: "🔧", label: "Detailing, Storage & Repair" },
];
...
export default function VendorsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="text-3xl md:text-4xl font-extrabold text-lake-blue mb-3">
          Chicago Boating Vendor Directory
        </h1>
        <p className="text-gray-600 max-w-2xl leading-relaxed">
          Boating Chicago is building the go-to directory for Lake Michigan boat rentals, charters, captains, and boating services. Browse published partners below — or list your business to get found by Chicago boaters.
        </p>
      </div>
      ...
      {published.length > 0 ? (
        ...
        <div className="bg-gradient-to-br from-light-blue/80 to-white rounded-3xl border border-sky-blue/20 p-8 md:p-12 mb-12 text-center">
          ...
          <p className="text-gray-600 max-w-xl mx-auto mb-8 leading-relaxed">
            We&apos;re onboarding boat rental companies, yacht charters, fishing operators, captains, marinas, and service providers across the Chicago lakefront. Be among the first featured listings when the directory fills in.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-lg mx-auto mb-8">
            {partnerCategories.map((cat) => (
              <div
                key={cat.label}
                className="flex flex-col items-center gap-1 p-3 bg-white rounded-xl border border-sky-blue/10"
              >
