    ...
    <>
      ...
      <section className="relative min-h-[40vh] flex items-end overflow-hidden text-white">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-white/90 max-w-2xl leading-relaxed animate-fade-up" style={{ animationDelay: "100ms" }}>
            Local boat rental companies, yacht charters, fishing captains, marinas, and service providers on Lake Michigan — with clear sponsored labeling when a listing is paid.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        {published.length > 0 ? (
          ...
          <div className="relative overflow-hidden rounded-3xl border border-sky-blue/20">
        ...
        <ExploreResources
          title="Browse while we onboard partners"
          description="Useful Chicago boating pages you can use today — rentals, harbors, destinations, and guides."
          links={exploreWhileWaiting}
        />
        ...
        <section className="max-w-3xl space-y-4 text-gray-700 leading-relaxed">
          ...
          <p>
            Featured and sponsored placements are labeled when they appear.
            Basic directory listings are free for qualified local operators.
            We do not invent business details — partners supply their own
